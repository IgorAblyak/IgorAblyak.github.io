...
$msg .= "<h2 style='font-weight:bold;border-bottom:1px dotted #ccc;'>Заявка с <b>X-PRO</b></h2>\r\n";
$msg .= "<p><strong>От кого:</strong> ".$username."</p>\r\n";
$msg .= "<p><strong>Почта:</strong> ".$usermail."</p>\r\n";
$msg .= "<p><strong>Телефон:</strong> ".$usertel."</p>\r\n";
$msg .= "<p><strong>Сообщение:</strong><div style='border: 2px solid gray; width: 300px;'> ".$usermessage."</div></p>\r\n";
$msg .= "</body></html>";
...
if(@mail($sendto, $subject, $msg, $headers)) {
  ...
  echo "<center><a href='index.html' style='color:red; cursor:pointer; font-size: 18px;'>Вернуться на главную</a></center>";
    ...
    echo "<center><h2>Что-то случилось...Попробуйте еще раз!</h2></center>";
}
